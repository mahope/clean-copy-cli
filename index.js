...
function extractReadable(html) {
  ...
  const CHROME = /(?:comment|sidebar|promo|advert|ads?[-_ ]|cookie|newsletter|signup|paywall|related|share[-_ ]?(?:bar|buttons)|social[-_ ]?(?:bar|buttons)?|footer|header[-_ ]?|hero[-_ ]?(?:image|banner)?|breadcrumb|lead[-_ ]?magnet|subscribe|byline|menu)/i;
