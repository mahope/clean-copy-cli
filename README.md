...
[![Version](https://img.shields.io/badge/version-1.5.2-blue)](https://github.com/mahope/clean-copy-cli/releases)
...
```bash
curl -L https://github.com/mahope/clean-copy-cli/releases/download/v1.5.2/clean-copy-1.5.2.tar.gz \
